# Antigravity Full-Stack Deployment Prompt — NT.QAMS v1.51.2
...
- `C:\install\NT.QAMS-webapi-v1.51.2-win-x64.zip`   (backend)
- `C:\install\NT.QAMS-frontend-v1.51.2-dist.zip`      (SPA + web.config)
