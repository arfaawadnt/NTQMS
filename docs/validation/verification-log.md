...
| ---- | ------ | --- | -----: | --: | ---: | ----: | ---: | ------: | ------: | --: | ------ |
| 2026-08-29 | `abcc881` | dev + throwaway PG 17.2 (`E:\pg-verify`, port 55432, full 80-migration chain; production untouched) | 450 | 142 | 192 | 30 (+9 skips) | 106 | **920** | 133 | — (not run) | All green — HQMS audit-remediation batch complete (B-01, M-05, M-07, M-08, M-10, M-11, M-12 code, M-14, M-16…M-20, N-04, N-05; commits `04a92ef…abcc881`, one per finding, each red-first). Six schema migrations executed Down/Up on the throwaway. The 9 integration skips are environment-conditional (runtime-role/superuser checks not applicable on the throwaway instance). Basis for REVAL-NTQMS-002 (doc 20) |
